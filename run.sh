...
NEXTDNS_ARGUMENTS="-listen :53 -report-client-info -log-queries -cache-size=${NEXTDNS_CACHE_SIZE} -max-ttl=${NEXTDNS_MAX_TTL}s -auto-activate -use-hosts -timeout 5s -discovery-dns -bogus-priv -max-inflight-requests 256"
